...
class Config {
    ...
    // ================================
    const DB_HOST = 'localhost';              // Servidor de base de datos
    ...
    // ================================
    const UPLOAD_DIR = 'uploads/';            // Directorio para archivos subidos (ruta absoluta)
    ...
    const BASE_URL = 'http://localhost/prueba_tecnica/'; // URL base del proyecto
